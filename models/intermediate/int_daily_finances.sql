SELECT
    ...
    COALESCE(r.total_revenue_added, 0) AS total_revenue_added,
    COALESCE(r.total_revenue_removed, 0) AS total_revenue_removed,
...
FULL OUTER JOIN
    (SELECT
        ...
        SUM(iv.ADD_TO_CART_QUANTITY * iv.PRICE_PER_UNIT) AS total_revenue_added,
        SUM(iv.REMOVE_FROM_CART_QUANTITY * iv.PRICE_PER_UNIT) AS total_revenue_removed,
